...
////         self.layer.borderColor = [UIColor colorWithHexString:@"333333"].CGColor;
...
//    }else if (_SegmentStyle == CBSegmentStyleZoom) {
            ...
            [UIView animateWithDuration:0.2 animations:^{
                ...
                self.selectedBtn.layer.borderColor = [UIColor colorWithHexString:@"333333"].CGColor;
//                self.selectedBtn.layer.borderWidth = 1;
                [self.selectedBtn setTitleColor:[UIColor colorWithHexString:@"333333"] forState:UIControlStateNormal];
