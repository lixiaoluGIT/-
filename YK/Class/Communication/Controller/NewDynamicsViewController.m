...
//            [weakSelf.dynamicsTable setContentOffset:CGPointMake(0, 320) animated:YES];
    ...
    [publicBtn setBackgroundImage:[UIImage imageNamed:@"Group 8"] forState:UIControlStateNormal];
    ...
    if (HEIGHT==812) {
        publicBtn.frame = CGRectMake(WIDHT/2-kSuitLength_H(138)/2, HEIGHT-kSuitLength_H(270), kSuitLength_H(138), kSuitLength_H(40));
    }else
    if (WIDHT==320) {
