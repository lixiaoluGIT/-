...
- (void)viewDidLoad {
    ...
    [self.navigationController.navigationBar setTitleTextAttributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:20],NSForegroundColorAttributeName:[UIColor colorWithHexString:@"333333"]}];
...
//    [_selectAll setTitle:@"全选" forState:UIControlStateNormal];
    [_selectAll setTitleColor:[UIColor colorWithHexString:@"333333"] forState:UIControlStateNormal];
...
//        [buttom setTitle:[NSString stringWithFormat:@"加入衣袋 (%ld/%ld)",[YKSuitManager sharedManager].suitAccount + useNum,totalNum] forState:UIControlStateNormal];
        ...
        if (status==0) {
            ...
            _btn.backgroundColor = [UIColor colorWithHexString:@"333333"];
